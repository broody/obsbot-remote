...
export class SegmentManager {
    ...
    public markForKeeping(timestamp: number, reason: string, bufferBeforeMs = 60000, bufferAfterMs = 30000) {
        ...
        console.log(`Marked segments between ${new Date(start).toISOString()} and ${new Date(end).toISOString()} for keeping. Reason: ${reason}`);
    }
    ...
    private cleanup() {
        ...
        const expiredSegments = this.db.prepare(`
